    ...
    <>
      <div className="noise-container ">
        ...
        <div className="space-y-72 bodydivLight dark:bodydivDark ">
          <div className="absolute w-full h-96 bg-gradient-to-b from-[#e6e6e6] dark:from-[#171920]/80" />
          <MainSection />
          <SkillSection />
          <TimelineSection />
          <SeeMoreSection />
          <ContactSection />
          <div className="absolute bottom-0 w-full h-96 bg-gradient-to-t from-[#e6e6e6] dark:from-[#171920]/80" />
        </div>
      </div>
    </>
  );
